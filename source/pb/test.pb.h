...
PROTOBUF_NAMESPACE_OPEN
template<> ::KvGame::Test* Arena::CreateMaybeMessage<::KvGame::Test>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace KvGame {
...
class Test final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KvGame.Test) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:KvGame.Test)
 private:
  class _Internal;
...
inline uint32_t Test::id() const {
  // @@protoc_insertion_point(field_get:KvGame.Test.id)
  return _internal_id();
}
...
inline void Test::set_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:KvGame.Test.id)
}
