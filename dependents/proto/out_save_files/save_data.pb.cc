...
static ::_pb::Metadata file_level_metadata_save_5fdata_2eproto[1];
...
const uint32_t TableStruct_save_5fdata_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::KwSave::Test, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::KwSave::Test, _impl_.id_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::KwSave::Test)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::KwSave::_Test_default_instance_._instance,
};
...
const char descriptor_table_protodef_save_5fdata_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_save_5fdata_2eproto_deps[1] = {
...
const ::_pbi::DescriptorTable descriptor_table_save_5fdata_2eproto = {
    false, false, 70, descriptor_table_protodef_save_5fdata_2eproto,
    "save_data.proto",
    &descriptor_table_save_5fdata_2eproto_once, descriptor_table_save_5fdata_2eproto_deps, 1, 1,
...
Test::Test(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:KwSave.Test)
}
Test::Test(const Test& from)
  ...
  // @@protoc_insertion_point(copy_constructor:KwSave.Test)
}
...
Test::~Test() {
  // @@protoc_insertion_point(destructor:KwSave.Test)
...
void Test::Clear() {
// @@protoc_insertion_point(message_clear_start:KwSave.Test)
...
uint8_t* Test::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:KwSave.Test)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:KwSave.Test)
  return target;
}

size_t Test::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:KwSave.Test)
  size_t total_size = 0;
...
void Test::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:KwSave.Test)
...
// @@protoc_insertion_point(class_specific_copy_from_start:KwSave.Test)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::KwSave::Test*
Arena::CreateMaybeMessage< ::KwSave::Test >(Arena* arena) {
  return Arena::CreateMessageInternal< ::KwSave::Test >(arena);
}
