...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Kw::Test, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Kw::Test, _impl_.id_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Kw::Test)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Kw::_Test_default_instance_._instance,
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\002Kw\"\022\n\004Test\022\n\n\002id\030\001 \001(\rb\006pr"
  "oto3"
  ;
static ::_pbi::once_flag descriptor_table_test_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 44, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
Test::Test(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Kw.Test)
}
Test::Test(const Test& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Kw.Test)
}
...
Test::~Test() {
  // @@protoc_insertion_point(destructor:Kw.Test)
...
void Test::Clear() {
// @@protoc_insertion_point(message_clear_start:Kw.Test)
...
uint8_t* Test::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Kw.Test)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Kw.Test)
  return target;
}

size_t Test::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Kw.Test)
  size_t total_size = 0;
...
void Test::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Kw.Test)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Kw.Test)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::Kw::Test*
Arena::CreateMaybeMessage< ::Kw::Test >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Kw::Test >(arena);
}
