...
PROTOBUF_NAMESPACE_OPEN
template<> ::Kw::Test* Arena::CreateMaybeMessage<::Kw::Test>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Kw {
...
class Test final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Kw.Test) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Kw.Test)
 private:
  class _Internal;
...
inline uint32_t Test::id() const {
  // @@protoc_insertion_point(field_get:Kw.Test.id)
  return _internal_id();
}
...
inline void Test::set_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Kw.Test.id)
}
